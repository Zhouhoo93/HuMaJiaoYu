...
+(MBProgressHUD *)showText:(NSString*)text {
    UIView *showView = [[UIApplication sharedApplication].windows lastObject];
    MBProgressHUD *hua = [MBProgressHUD showHUDAddedTo:showView animated:YES];
    hua.detailsLabelText = text;
    hua.detailsLabelFont = [UIFont systemFontOfSize:17];
    // 隐藏时候从父控件中移除
    hua.removeFromSuperViewOnHide = YES;
    // YES代表需要蒙版效果
    hua.dimBackground = NO;
    hua.mode = MBProgressHUDModeText;
    [hua hide:YES afterDelay:1.5];
    return hua;
}
